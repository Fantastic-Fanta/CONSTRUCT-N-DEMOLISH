...
-- Import services
local Garage = "EDIT THIS VALUE" -- E.g Garage 2
local G = game.Workspace.Garages[Garage]
local Parts = G.Parts:Clone():GetChildren()
for _,v in ipairs(Parts) do v.Position = v.Position - G.BuildZone.Position end
...
function InflateBuildData(Data)
